...
public class Display
{
	 ...
	 * @param width The width of the window
	 * @param height The height of the window
	 * @param borderless Whether or not to make the window borderless
	 */
	 ...
	 * @param xhot The x position in the image that equals 0,0
	 * @param yhot The y position in the image that equals 0,0
	 */
	...
	{
		return GLFW.glfwGetMouseButton(windowID, 0) == GLFW.GLFW_TRUE ? 0
				: GLFW.glfwGetMouseButton(windowID, 1) == GLFW.GLFW_TRUE ? 1 : GLFW.glfwGetMouseButton(windowID, 2) == GLFW.GLFW_TRUE ? 2 : -1;
	}
