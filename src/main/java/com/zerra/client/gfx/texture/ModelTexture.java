...
public class ModelTexture
{
	 ...
	 * 
	 * @param numberOfRows The number of rows this model texture will have.
	 ...
	 * 
	 * @param transparent Sets whether or not the model texture has transparency.
	 * @return The model texture.
	 */
	 ...
	 * 
	 * @param useFakeLighting Sets whether or not the model texture will use fake
	 *        lighting.
	 * @return The model texture.
	 */
