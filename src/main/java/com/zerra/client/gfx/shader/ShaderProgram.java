...
public abstract class ShaderProgram
{
	...
	/**
	 * The default implementation of a shader program containing what any shader
	 * program needs.
	 * 
	 * @param domain The domain the shader is in
	 * @param baseName Takes the name and looks for files named baseName_vertex.glsl
	 *        and baseName_fragment.glsl. The folder these are also searched for is
	 *        res/assets/domain/shaders.
	 */
	 ...
	 * program needs.
	 * 
	 * @param vertexFile The vertex shader file location found as /vertexFile.glsl
	 * @param fragmentFile The fragment shader file location found as
	 *        /fragmentFile.glsl
	 */
	...
	/**
	 * Sets all the uniform location integers to the locations of the variables in
	 * the shaders.
	 */
	...
	// System.out.println(matrix4Buffer.get(0) + " " + matrix4Buffer.get(4) + " " +
	// matrix4Buffer.get(8) + " " + matrix4Buffer.get(12) + "\n" +
	// matrix4Buffer.get(1) + " " + matrix4Buffer.get(5) + " " +
	// matrix4Buffer.get(9) + " " + matrix4Buffer.get(13) + "\n" +
	// matrix4Buffer.get(2) + " " + matrix4Buffer.get(6) + " " +
	// matrix4Buffer.get(10) + " " + matrix4Buffer.get(14) + "\n" +
	// matrix4Buffer.get(3) + " " + matrix4Buffer.get(7) + " " +
	// matrix4Buffer.get(11) + " " + matrix4Buffer.get(15) + "\n");
