...
/**
 * Wraps the {@link UBObject} to provide simpler methods mostly for getting and
 * setting
 */
public class UBObjectWrapper
{
	...
	/**
	 * Helper method to create a {@link UBObjectWrapper} from a {@link UBValue} if
	 * possible Returns null if the value is not a {@link UBObject}
	 *
	...
	/**
	 * Sets a generic {@link UBValue} to {@link UBObjectWrapper#ubObject} Used
	 * internally in this class only
	 */
	...
	/**
	 * Tries to create a {@link UBValue} for this object Will return true if
	 * creation was successful and the object was added This should work for most
	 * primitive types as well as {@link java.util.Map}s, {@link Iterable}s and
	 * {@link UBArray}s
	 *
	 * @param key Key
	...
	/**
	 * Gets a generic {@link UBValue} from {@link UBObjectWrapper#ubObject} Used
	 * internally in this class only
	 */
	...
	/**
	 * Returns true if the key-value pair does not exist, or the key is mapped to
	 * null
	 */
	...
	/**
	 * Gets a {@link Boolean} from the wrapped {@link UBObject} Returns null if the
	 * value was not a boolean or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a boolean from the wrapped {@link UBObject} If the value was null, then
	 * will return false
	 */
	...
	/**
	 * Gets a {@link Byte} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a byte from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link Short} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a short from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link Integer} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets an integer from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link Long} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a long from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link Float} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a float from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link Double} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a double from the wrapped {@link UBObject} If the value was null, then
	 * will return 0
	 */
	...
	/**
	 * Gets a {@link String} from the wrapped {@link UBObject} Returns null if the
	 * value was not a number or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a {@link String} from the wrapped {@link UBObject} If the value was
	 * null, then will return an empty String
	 */
	...
	/**
	 * Gets a {@link UUID} from the wrapped {@link UBObject} Returns null if either
	 * of the component parts of the UUID do not exist
	 */
	...
	/**
	 * Gets a {@link UBObject} from the wrapped {@link UBObject} Returns null if the
	 * value was not an object or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a {@link UBObjectWrapper} from the wrapped {@link UBObject} Returns null
	 * if the value was not an object or the key-value pair did not exist
	 */
	...
	/**
	 * Gets a {@link UBArray} from the wrapped {@link UBObject} Returns null if the
	 * value was not an array or the key-value pair did not exist
	 */
