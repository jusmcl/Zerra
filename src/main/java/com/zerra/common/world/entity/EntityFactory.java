...
/**
 * A factory class used to create new {@link T} instances and some methods to
 * determine when and where this entity can spawn
 */
public class EntityFactory<T extends Entity> extends Factory<T>
{
	 ...
	 * instance of the {@link T} should be created for the given layer ID
	 *
	 * @param layerPredicate Predicate to check if the {@link T} should be created
	...
	/**
	 * This method is called for the layer to check if an instance of this {@link T}
	 * should be created
	 *
	...
	/**
	 * Sets a tile {@link Predicate<Tile>} which should return true if an instance
	 * of the {@link T} should be created for the given tile
	 *
	 * @param tilePredicate Predicate to check if the {@link T} should be created
	 *        for the given tile
	 * @return This {@link EntityFactory}
	 */
	...
	/**
	 * This method is called for the tile to check if an instance of this {@link T}
	 * should be created
	 *
	 * @param tile Tile
