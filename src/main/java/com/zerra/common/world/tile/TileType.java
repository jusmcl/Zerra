...
public class TileType implements RegistryNameable
{
	 ...
	 * @param hardness the hardness of the tile (how long it takes to be broken)
	 *        unless specified by the tool/item used the breaktime will be
	 *        ((hardness * harvestLevel) / toolLevel) * 0.5 seconds
	 * @param harvestLevel the minimum level of tool you need to be able to
	 *        'harvest' (collect drops) by breaking this tile
	 * @param toolType a String specifying the type of tool that can break this
	 *        Tile. See DefaultToolTypes.class
	 */
	...
	public int hashCode()
	{
		return new HashCodeBuilder(17, 37).append(getRegistryName()).append(getHardness()).append(getToolType()).append(getHarvestLevel()).toHashCode();
	}
