...
public class ExampleDependency implements Mod
{
	...
	{
		return new ModInfoBuilder("exampledependency", "Example Dependency", "1.0", "0.0.6").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
