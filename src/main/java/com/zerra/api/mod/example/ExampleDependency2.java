...
public class ExampleDependency2 implements Mod
{
	...
	{
		return new ModInfoBuilder("exampledependency2", "Example Dependency 2", "1.0", "0.0.5").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
