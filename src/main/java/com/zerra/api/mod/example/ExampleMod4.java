...
public class ExampleMod4 implements Mod
{
	...
	private ModInfo info = new ModInfoBuilder("examplemod4", "Example Mod 4", "1.0", "0.0.6").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
