...
public class ExampleMod4 implements Mod
{
	...
	{
		return new ModInfoBuilder("examplemod4", "Example Mod 4", "1.0", "0.0.4").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
