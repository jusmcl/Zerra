...
public class ExampleMod3 implements Mod
{
	...
	private ModInfo info = new ModInfoBuilder("examplemod3", "Example Mod 3", "1.0", "0.0.5").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
