...
public class ExampleMod implements Mod
{
	...
	private ModInfo info = new ModInfoBuilder("examplemod", "Example Mod", "1.0", "0.0.6").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
