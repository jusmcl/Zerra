...
public class ExampleMod implements Mod
{
	...
	public ModInfo info = new ModInfoBuilder("examplemod", "Example Mod", "1.0", "0.0.4").setAuthors("Arpaesis").setCredits("Credits to the Zerra development team for making the game!")
