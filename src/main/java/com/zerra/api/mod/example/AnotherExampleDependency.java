...
public class AnotherExampleDependency implements Mod
{
	...
	{
		return new ModInfoBuilder("anotherexampledependency", "Another Example Dependency", "1.0", "0.0.4").setAuthors("Arpaesis")
				.setCredits("Credits to the Zerra development team for making the game!").setModDescription("A simple example dependency.").setWebsiteURL("https://www.example.com").build();
	}
}
